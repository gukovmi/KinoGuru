package com.shellwoo.kinoguru.feature.movie.search.data.datasource
...
internal class MovieSearchOnboardingShowingDataSourceImplTest {

    private val dataStore: DataStore<Preferences> = mock()

    private val dataSource = MovieSearchOnboardingShowingDataSourceImpl(dataStore)
